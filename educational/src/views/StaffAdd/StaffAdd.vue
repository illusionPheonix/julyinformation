      ...
      <div class="text item">
        ...
        >
          ...
          <el-form-item label="员工分组" prop="staffGrounp">
              ...
              <el-option v-for="(val,index) in staffOptions" :key="index" :label="val.label" :value="val.value"></el-option>
              </el-select>
          </el-form-item>
          <!-- 密码 -->
          ...
          <!-- 按钮组 -->
          <el-form-item>
            <el-button type="success" @click="submitForm('staffAddForm')">添加</el-button>
    ...
    data(){
        ...
        const validateAccount=(rule, value, callback) => {
            if(!value){
                ...
                // 向后端发送请求，查找数据库中是否有当前用户名
                this.request.get('/staff/checkaccount',params)
                .then(res=>{
                    // 接收后端传回来的参数
                    let { code,msg }=res;
                    if(code===0){
