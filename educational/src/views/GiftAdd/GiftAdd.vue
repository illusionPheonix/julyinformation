    ...
    <el-card class="box-card">
        ...
        <div class="text item">
            ...
            >
                ...
                <!-- 按钮组 -->
                <el-form-item>
                    <el-button type="success" @click="submitForm('giftAddForm')">添加</el-button>
    ...
    methods:{
        ...
        submitForm(formName) {
            ...
            if (valid) {
                // 提交数据给后端
                let params = {
                    giftclassify:this.giftAddForm.giftClassify,
                    giftname: this.giftAddForm.giftName,
                    giftcode:this.giftAddForm.giftCode,
                    costscore:this.giftAddForm.costScore,
                    price:this.giftAddForm.price,
                    stocknum:this.giftAddForm.stockNum,
                    giftunit:this.giftAddForm.giftUnit,
                    issale:this.giftAddForm.isSale,
                    giftdesc:this.giftAddForm.giftDesc
                };     
                //向后端发送数据
                    this.request.post('/gift/giftadd',params)    
                    .then(res=>{
                        // 接收数据
                        let { code , msg } = res;
                        if(code===0){
